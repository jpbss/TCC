...
class Block1(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return ans
class Block1_1(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(Block1_1, self).__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
    ...
    def forward(self, inputs):
        ...
        # print('ans shape: ', ans.shape)
        return ans
class Block1_2(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(Block1_2, self).__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
...
class SRNet(nn.Module):
    def __init__(self, data_format='NCHW', init_weights=True):
        ...
        self.layer1 = Block1_1(1, 64)
        self.layer2 = Block1_2(64, 16)
